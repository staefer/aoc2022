...
func main() {
	...
	for {
		...
		if range1_1 <= range2_1 && range1_2 >= range2_2 { // Range 2 contains range 2
			sum++
		} else if range2_1 <= range1_1 && range2_2 >= range1_2 { // Range 1 contains range 2
			sum++
		} else if range1_1 <= range2_1 && range1_2 >= range2_1 { // Range 1 overlaps left side of range 2
			sum++
		} else if range1_1 <= range2_2 && range1_2 >= range2_1 { // Range 1 overlaps right side of range 2
			sum++
		}
	}
	fmt.Println(sum)
